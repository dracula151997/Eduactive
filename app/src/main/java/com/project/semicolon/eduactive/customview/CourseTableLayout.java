...
public class CourseTableLayout extends LinearLayout {
    ...
    private void initCourseTable() {
        ...
        LayoutParams titleRowParams = new LayoutParams(
...
//                    tableCell.setElevation(20.0f);
    ...
    private int[] getColorArray(int color_count) {
        ...
        int[] ints = getContext().getResources().getIntArray(R.array.random_color);
    ...
    private void setTableCell(int row, int col, int color, CourseInfo course) {
        ...
        if (tableRow != null) {
            CourseBlock tableCell = (CourseBlock) tableRow.getChildAt(col);
            tableCell.setVisibility(View.INVISIBLE);
            tableCell.setText(course.getName().trim());
            tableCell.setTag(course);
            tableCell.setBackgroundColor(color);
            tableCell.setOnClickListener(onClickListener);
            setAnimation(tableCell);
        }
    }
